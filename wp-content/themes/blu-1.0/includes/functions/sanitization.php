...
function et_sanitize_font_style( $styles ) {
	...
	$allowed_styles = array_keys( sevenp_blu_font_style_choices() );
...
function et_sanitize_color_scheme( $choosen ) {
	return et_sanitize_key_based_option( $choosen, sevenp_blu_color_scheme_choices() );
}
...
function et_sanitize_header_style( $choosen ) {
	return et_sanitize_key_based_option( $choosen, sevenp_blu_header_style_choices() );
}
...
function et_sanitize_dropdown_animation( $choosen ) {
	return et_sanitize_key_based_option( $choosen, sevenp_blu_dropdown_animation_choices() );
}
...
function et_sanitize_footer_column( $choosen ) {
	return et_sanitize_key_based_option( $choosen, sevenp_blu_footer_column_choices() );
}
...
function et_sanitize_yes_no( $choosen ) {
	return et_sanitize_key_based_option( $choosen, sevenp_blu_yes_no_choices() );
}
...
function et_sanitize_left_right( $choosen ) {
	return et_sanitize_key_based_option( $choosen, sevenp_blu_left_right_choices() );
}
...
function et_sanitize_image_animation( $choosen ) {
	return et_sanitize_key_based_option( $choosen, sevenp_blu_image_animation_choices() );
}
...
function et_sanitize_divider_style( $choosen ) {
	return et_sanitize_key_based_option( $choosen, sevenp_blu_divider_style_choices() );
}
...
function et_sanitize_divider_position( $choosen ) {
	return et_sanitize_key_based_option( $choosen, sevenp_blu_divider_position_choices() );
}
