...
function et_fb_backend_helpers() {
	...
	$helpers['i18n'] = array(
		...
		'saveModuleLibraryAttrs'        => array(
			...
			'descriptionText'       => esc_html__( 'Here you can add the current item to your Blu Library for later use.', 'et_builder' ),
			'descriptionTextLayout' => esc_html__( 'Save your current page to the Blu Library for later use.', 'et_builder' ),
