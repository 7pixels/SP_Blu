...
( function( $ ) {
	...
	function et_fix_logo_height() {
		var header_style       = typeof wp.customize.value( 'sevenp_blu[header_style]' )() === 'undefined' ? 'left' : wp.customize.value( 'sevenp_blu[header_style]' )(),
			menu_height        = typeof wp.customize.value( 'sevenp_blu[menu_height]' )() === 'undefined' ? 66 : parseInt( wp.customize.value( 'sevenp_blu[menu_height]' )() ),
			fixed_menu_height  = ! $('#fixed_menu_height').length || typeof wp.customize.value( 'sevenp_blu[minimized_menu_height]' )() === 'undefined' ? 40 : parseInt( wp.customize.value( 'sevenp_blu[minimized_menu_height]' )() ),
			logo_height        = typeof wp.customize.value( 'sevenp_blu[logo_height]' )() === 'undefined' ? 54 : parseInt( wp.customize.value( 'sevenp_blu[logo_height]' )() ),
			$body              = $('body'),
	...
	function et_fix_main_header_box_shadow() {
		var primary_nav_bg 					= wp.customize( 'sevenp_blu[primary_nav_bg]' )(),
			fixed_primary_nav_bg 			= $( 'body' ).hasClass( 'et_fixed_nav' ) ?  wp.customize( 'sevenp_blu[fixed_primary_nav_bg]' )() : '',
	...
	*/
		...
		switch( type ){
			case 'font-size':
				...
				var smaller_title_sections = [
					'sevenp_blu[et_pb_audio-header_font_size]',
					'sevenp_blu[et_pb_blog-title_font_size]',
					'sevenp_blu[et_pb_cta-header_font_size]',
					'sevenp_blu[et_pb_contact_form-header_font_size]',
					'sevenp_blu[et_pb_login-header_font_size]',
					'sevenp_blu[et_pb_signup-header_font_size]',
					'sevenp_blu[et_pb_slider-header_font_size]',
					'sevenp_blu[et_pb_slider-body_font_size]',
					'sevenp_blu[et_pb_countdown_timer-header_font_size]'
				];
				...
				if( $.inArray( id, smaller_title_sections ) ){
					...
					switch ( id ) {
						case 'sevenp_blu[et_pb_slider-header_font_size]':
							var font_size = parseInt( value ) * .565217391; // 26/46
							break;

						case 'sevenp_blu[et_pb_slider-body_font_size]':
	...
	wp.customize( 'sevenp_blu[link_color]', function( value ) {
		value.bind( function( to ) {
			$( 'article p:not(.post-meta) a, .comment-edit-link, .pinglist a, .pagination a' ).css( 'color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[body_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[phone_body_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[tablet_body_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[section_padding]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[row_padding]', function( value ) {
		value.bind( function( to ) {
			$( '.et_pb_row' ).css( 'padding', to + '% 0' );
		} );
	} );

	wp.customize( 'sevenp_blu[phone_row_height]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[tablet_row_height]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[phone_section_height]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[tablet_section_height]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[body_header_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[body_header_height]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[body_font_height]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[body_header_spacing]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[primary_nav_font_spacing]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[secondary_nav_fullwidth]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
	...
	wp.customize( 'sevenp_blu[secondary_nav_font_spacing]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[phone_header_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[tablet_header_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[font_color]', function( value ) {
		value.bind( function( to ) {
			$( 'body' ).css( 'color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[accent_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[primary_nav_bg]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body'),
	...
	wp.customize( 'sevenp_blu[secondary_nav_bg]', function( value ) {
		value.bind( function( to ) {
			$( '#top-header, #et-secondary-nav li ul' ).css( 'background-color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[secondary_nav_dropdown_bg]', function( value ) {
		value.bind( function( to ) {
			$( '#et-secondary-nav li ul' ).css( 'background-color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[secondary_nav_dropdown_link_color]', function( value ) {
		value.bind( function( to ) {
			$( '#et-secondary-nav li ul a' ).css( 'color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[primary_nav_dropdown_bg]', function( value ) {
		value.bind( function( to ) {
			$( '#et-top-navigation li ul' ).css( 'background-color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[primary_nav_dropdown_line_color]', function( value ) {
		value.bind( function( to ) {
			$( '.nav li ul' ).css( 'border-color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[primary_nav_dropdown_link_color]', function( value ) {
		value.bind( function( to ) {
			$( '#et-top-navigation li ul a' ).css( 'color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[fixed_secondary_nav_bg]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[fixed_primary_nav_bg]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[mobile_primary_nav_bg]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[fixed_primary_nav_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[fixed_menu_link]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[fixed_menu_link_active]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[fixed_secondary_menu_link]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[header_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[disable_custom_footer_credits]', function( value ) {
		value.bind( function( to ) {
			var footer_info_html = '';

			if ( to === false ) {
				var custom_footer_credits = wp.customize.value('sevenp_blu[custom_footer_credits]')();
	...
	wp.customize( 'sevenp_blu[custom_footer_credits]', function( value ) {
		value.bind( function( to ) {
			if ( $.trim( to ) === '' ) {
	...
	wp.customize( 'sevenp_blu[footer_bg]', function( value ) {
		value.bind( function( to ) {
			$( '#main-footer' ).css( 'background-color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[footer_columns]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
			if ( to ) {
	...
	wp.customize( 'sevenp_blu[footer_widget_link_color]', function( value ) {
		value.bind( function( to ) {
			$( '#footer-widgets .footer-widget li a' ).css( 'color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[footer_widget_text_color]', function( value ) {
		value.bind( function( to ) {
			$( '.footer-widget' ).css( 'color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[footer_widget_header_color]', function( value ) {
		value.bind( function( to ) {
			$( '#main-footer .footer-widget h4' ).css( 'color', to );
		} );
	} );

	wp.customize( 'sevenp_blu[footer_widget_bullet_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[widget_header_font_size]', function( value ) {
		value.bind( function( to ) {
				$( '.footer-widget h4' ).css( 'font-size', to + 'px' );
		} );
	} );

	wp.customize( 'sevenp_blu[widget_header_font_style]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[widget_header_font_style]',
				'font-styles',
				'.footer-widget h4',
				to
			);
	...
	wp.customize( 'sevenp_blu[widget_body_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[footer_menu_background_color]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[footer_menu_background_color]',
				'background-color',
				'#et-footer-nav',
				to
			);
	...
	wp.customize( 'sevenp_blu[footer_menu_text_color]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[footer_menu_text_color]',
				'color',
	...
	wp.customize( 'sevenp_blu[footer_menu_active_link_color]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[footer_menu_active_link_color]',
				'color',
	...
	wp.customize( 'sevenp_blu[footer_menu_letter_spacing]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[footer_menu_letter_spacing]',
				'letter-spacing',
				'.bottom-nav',
				to
			);
	...
	wp.customize( 'sevenp_blu[footer_menu_font_style]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[footer_menu_font_style]',
				'font-styles',
				'.bottom-nav a',
				to
			);
	...
	wp.customize( 'sevenp_blu[footer_menu_font_size]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[footer_menu_font_size]',
				'font-size',
	...
	wp.customize( 'sevenp_blu[bottom_bar_background_color]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[bottom_bar_background_color]',
				'background-color',
				'#footer-bottom',
				to
			);
	...
	wp.customize( 'sevenp_blu[bottom_bar_text_color]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[bottom_bar_text_color]',
				'color',
	...
	wp.customize( 'sevenp_blu[bottom_bar_font_style]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[bottom_bar_font_style]',
				'font-styles',
				'#footer-info, #footer-info a',
				to
			);
	...
	wp.customize( 'sevenp_blu[bottom_bar_font_size]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[bottom_bar_font_size]',
				'font-size',
				'#footer-info',
				to,
				true
	...
	wp.customize( 'sevenp_blu[bottom_bar_social_icon_size]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[bottom_bar_social_icon_size]',
				'font-size',
	...
	wp.customize( 'sevenp_blu[bottom_bar_social_icon_color]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[bottom_bar_social_icon_color]',
				'color',
				'#footer-bottom .et-social-icon a',
				to
			);
	...
	wp.customize( 'sevenp_blu[widget_body_font_style]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[widget_body_font_style]',
				'font-styles',
	...
	wp.customize( 'sevenp_blu[widget_body_line_height]', function( value ) {
		value.bind( function( to ) {
			et_print_module_styles_css(
				'sevenp_blu[widget_body_line_height]',
				'line-height',
				'.footer-widget .et_pb_widget div, .footer-widget .et_pb_widget ul, .footer-widget .et_pb_widget ol, .footer-widget .et_pb_widget label',
				to
			);
	...
	wp.customize( 'sevenp_blu[menu_link]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[secondary_nav_text_color_new]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[mobile_menu_link]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[gutter_width]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
			if ( to ) {
	...
	wp.customize( 'sevenp_blu[sidebar_width]', function( value ) {
		value.bind( function( to ) {
			add_content_sidebar_style( to );
		} );
	} );

	wp.customize( 'sevenp_blu[use_sidebar_width]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');

			if ( to ) {
				$body.removeClass( 'et_pb_gutter ' );
				add_content_sidebar_style( wp.customize.value( 'sevenp_blu[sidebar_width]' )() );
			} else {
	...
	wp.customize( 'sevenp_blu[boxed_layout]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
			if ( to ) {
	...
	wp.customize( 'sevenp_blu[cover_background]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
	...
	wp.customize( 'sevenp_blu[show_header_social_icons]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[show_search_icon]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
	...
	wp.customize( 'sevenp_blu[show_footer_social_icons]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[header_style]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[primary_nav_dropdown_animation]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[secondary_nav_dropdown_animation]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[phone_number]', function( value ) {
		value.bind( function( to ) {
			et_maybe_create_secondary_nav();
	...
	wp.customize( 'sevenp_blu[header_email]', function( value ) {
		value.bind( function( to ) {
			et_maybe_create_secondary_nav();
	...
	wp.customize( 'sevenp_blu[primary_nav_text_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[secondary_nav_text_color]', function( value ) {
		value.bind( function( to ) {
			var nav_color_prefix = 'et_nav_text_color_',
				element = '#top-header';
	...
	wp.customize( 'sevenp_blu[vertical_nav]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body'),
	...
	wp.customize( 'sevenp_blu[vertical_nav_orientation]', function( value ) {
		value.bind( function( to ) {
			var $body = $( 'body' );
	...
	wp.customize( 'sevenp_blu[hide_nav]', function( value ) {
		value.bind( function( to ) {
			var $window = $(window),
				$body = $('body'),
	...
	wp.customize( 'sevenp_blu[hide_primary_logo]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
	...
	wp.customize( 'sevenp_blu[hide_fixed_logo]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
	...
	wp.customize( 'sevenp_blu[hide_mobile_logo]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
	...
	wp.customize( 'sevenp_blu[color_schemes]', function( value ) {
		value.bind( function( to ) {
			var $body = $( 'body' ),
	...
	wp.customize( 'sevenp_blu[nav_fullwidth]', function( value ) {
		value.bind( function( to ) {
			var $body = $('body');
	...
	wp.customize( 'sevenp_blu[menu_height]', function( value ) {
		value.bind( function( to ) {
			// Update height data
	...
	wp.customize( 'sevenp_blu[logo_height]', function( value ) {
		value.bind( function( to ) {
			var header_style = typeof wp.customize.value( 'sevenp_blu[header_style]' )() === 'undefined' ? 'left' : wp.customize.value( 'sevenp_blu[header_style]' )();
	...
	wp.customize( 'sevenp_blu[menu_margin_top]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[minimized_menu_height]', function( value ) {
		value.bind( function( to ) {
			// Update height data
	...
	wp.customize( 'sevenp_blu[secondary_nav_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[primary_nav_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	/* Module Styles Panel */
		...
		/* Gallery */
			wp.customize( 'sevenp_blu[et_pb_gallery-zoom_icon_color]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_gallery-zoom_icon_color]',
						'color',
			...
			wp.customize( 'sevenp_blu[et_pb_gallery-hover_overlay_color]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_gallery-hover_overlay_color]',
						'background-color',
			...
			wp.customize( 'sevenp_blu[et_pb_gallery-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_gallery-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_gallery-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_gallery-title_font_style]',
						'font-styles',
						'.et_pb_gallery_grid .et_pb_gallery_item .et_pb_gallery_title',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_gallery-caption_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_gallery-caption_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_gallery-caption_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_gallery-caption_font_style]',
						'font-styles',
						'.et_pb_gallery .et_pb_gallery_item .et_pb_gallery_caption',
						to
					);
		...
		/* Blurb */
			wp.customize( 'sevenp_blu[et_pb_blurb-header_font_size]', function( value ) {
				value.bind( function( to ) {
					// Print style
					et_print_module_styles_css(
						'sevenp_blu[et_pb_blurb-header_font_size]',
						'font-size',
						'.et_pb_blurb h4',
						to
					);
		...
		/* Tabs */
			wp.customize( 'sevenp_blu[et_pb_tabs-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_tabs-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_tabs-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_tabs-title_font_style]',
						'font-styles',
						'.et_pb_tabs_controls li',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_tabs-padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_tabs-padding]',
						'padding-tabs',
						'',
						to
					);
		...
		/* Slider */
			wp.customize( 'sevenp_blu[et_pb_slider-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_slider-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_slider-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_slider-header_font_style]',
						'font-styles',
						'.et_pb_slider_fullwidth_off .et_pb_slide_description .et_pb_slide_title',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_slider-body_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_slider-body_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_slider-body_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_slider-body_font_style]',
						'font-styles',
						'.et_pb_slider_fullwidth_off .et_pb_slide_content',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_slider-padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_slider-padding]',
						'padding-slider',
		...
		/* Testimonial */
			wp.customize( 'sevenp_blu[et_pb_testimonial-portrait_border_radius]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_testimonial-portrait_border_radius]',
						'border-radius',
			...
			wp.customize( 'sevenp_blu[et_pb_testimonial-portrait_width]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_testimonial-portrait_width]',
						'width',
			...
			wp.customize( 'sevenp_blu[et_pb_testimonial-portrait_height]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_testimonial-portrait_height]',
						'height',
						'.et_pb_testimonial_portrait',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_testimonial-author_name_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_testimonial-author_name_font_style]',
						'font-styles',
			...
			wp.customize( 'sevenp_blu[et_pb_testimonial-author_details_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_testimonial-author_details_font_style]',
						'font-styles',
		...
		/* Pricing Table */
			wp.customize( 'sevenp_blu[et_pb_pricing_tables-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_pricing_tables-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_pricing_tables-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_pricing_tables-header_font_style]',
						'font-styles',
						'.et_pb_pricing_heading h2',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_pricing_tables-subheader_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_pricing_tables-subheader_font_size]',
						'font-size',
						'.et_pb_best_value',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_pricing_tables-subheader_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_pricing_tables-subheader_font_style]',
						'font-styles',
						'.et_pb_best_value',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_pricing_tables-price_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_pricing_tables-price_font_size]',
						'font-size',
						'.et_pb_sum',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_pricing_tables-price_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_pricing_tables-price_font_style]',
						'font-styles',
						'.et_pb_sum',
						to
					);
		...
		/* Call to Action */
			wp.customize( 'sevenp_blu[et_pb_cta-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_cta-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_cta-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_cta-header_font_style]',
						'font-styles',
						'.et_pb_promo h2',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_cta-custom_padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_cta-custom_padding]',
		...
		/* Audio */
			wp.customize( 'sevenp_blu[et_pb_audio-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_audio-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_audio-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_audio-title_font_style]',
						'font-styles',
						'.et_pb_audio_module_content h2',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_audio-caption_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_audio-caption_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_audio-caption_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_audio-caption_font_style]',
						'font-styles',
						'.et_pb_audio_module p',
						to
					);
		...
		/* Email Optin */
			wp.customize( 'sevenp_blu[et_pb_signup-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_signup-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_signup-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_signup-header_font_style]',
						'font-styles',
						'.et_pb_subscribe h2',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_signup-padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_signup-padding]',
						'padding',
						'.et_pb_subscribe',
						to
					);
		...
		/* Login */
			wp.customize( 'sevenp_blu[et_pb_login-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_login-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_login-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_login-header_font_style]',
						'font-styles',
						'.et_pb_login h2',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_login-custom_padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_login-custom_padding]',
						'padding',
						'.et_pb_login',
						to
					);
		...
		/* Portfolio */
			wp.customize( 'sevenp_blu[et_pb_portfolio-zoom_icon_color]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_portfolio-zoom_icon_color]',
						'color',
			...
			wp.customize( 'sevenp_blu[et_pb_portfolio-hover_overlay_color]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_portfolio-hover_overlay_color]',
						'background-color',
			...
			wp.customize( 'sevenp_blu[et_pb_portfolio-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_portfolio-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_portfolio-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_portfolio-title_font_style]',
						'font-styles',
						'.et_pb_portfolio .et_pb_portfolio_item h2, .et_pb_fullwidth_portfolio .et_pb_portfolio_item h3, .et_pb_portfolio_grid .et_pb_portfolio_item h2',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_portfolio-caption_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_portfolio-caption_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_portfolio-caption_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_portfolio-caption_font_style]',
						'font-styles',
						'.et_pb_portfolio .et_pb_portfolio_item .post-meta, .et_pb_fullwidth_portfolio .et_pb_portfolio_item .post-meta, .et_pb_portfolio_grid .et_pb_portfolio_item .post-meta',
						to
					);
		...
		/* Filterable Portfolio */
			wp.customize( 'sevenp_blu[et_pb_filterable_portfolio-zoom_icon_color]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_filterable_portfolio-zoom_icon_color]',
						'color',
			...
			wp.customize( 'sevenp_blu[et_pb_filterable_portfolio-hover_overlay_color]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_filterable_portfolio-hover_overlay_color]',
						'background-color',
			...
			wp.customize( 'sevenp_blu[et_pb_filterable_portfolio-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_filterable_portfolio-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_filterable_portfolio-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_filterable_portfolio-title_font_style]',
						'font-styles',
						'.et_pb_filterable_portfolio .et_pb_portfolio_item h2',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_filterable_portfolio-caption_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_filterable_portfolio-caption_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_filterable_portfolio-caption_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_filterable_portfolio-caption_font_style]',
						'font-styles',
						'.et_pb_filterable_portfolio .et_pb_portfolio_item .post-meta',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_filterable_portfolio-filter_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_filterable_portfolio-filter_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_filterable_portfolio-filter_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_filterable_portfolio-filter_font_style]',
						'font-styles',
						'.et_pb_filterable_portfolio .et_pb_portfolio_filters li',
						to
					);
		...
		/* Bar Counter */
			wp.customize( 'sevenp_blu[et_pb_counters-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_counters-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_counters-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_counters-title_font_style]',
						'font-styles',
						'.et_pb_counters .et_pb_counter_title',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_counters-percent_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_counters-percent_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_counters-percent_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_counters-percent_font_style]',
						'font-styles',
						'.et_pb_counters .et_pb_counter_amount',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_counters-border_radius]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_counters-border_radius]',
						'border-radius',
			...
			wp.customize( 'sevenp_blu[et_pb_counters-padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_counters-padding]',
						'padding',
		...
		/* Circle Counter */
			wp.customize( 'sevenp_blu[et_pb_circle_counter-number_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_circle_counter-number_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_circle_counter-number_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_circle_counter-number_font_style]',
						'font-styles',
						'.et_pb_circle_counter .percent p',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_circle_counter-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_circle_counter-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_circle_counter-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_circle_counter-title_font_style]',
						'font-styles',
						'.et_pb_circle_counter h3',
						to
					);
		...
		/* Number Counter */
			wp.customize( 'sevenp_blu[et_pb_number_counter-number_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_number_counter-number_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_number_counter-number_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_number_counter-number_font_style]',
						'font-styles',
						'.et_pb_number_counter .percent p',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_number_counter-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_number_counter-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_number_counter-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_number_counter-title_font_style]',
						'font-styles',
						'.et_pb_number_counter h3',
						to
					);
		...
		/* Accordion */
			wp.customize( 'sevenp_blu[et_pb_accordion-toggle_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_accordion-toggle_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_accordion-toggle_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_accordion-toggle_font_style]',
						'font-styles',
			...
			wp.customize( 'sevenp_blu[et_pb_accordion-inactive_toggle_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_accordion-inactive_toggle_font_style]',
						'font-styles',
			...
			wp.customize( 'sevenp_blu[et_pb_accordion-toggle_icon_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_accordion-toggle_icon_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_accordion-custom_padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_accordion-custom_padding]',
						'padding',
		...
		/* Toggle */
			wp.customize( 'sevenp_blu[et_pb_toggle-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_toggle-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_toggle-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_toggle-title_font_style]',
						'font-styles',
			...
			wp.customize( 'sevenp_blu[et_pb_toggle-inactive_title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_toggle-inactive_title_font_style]',
						'font-styles',
			...
			wp.customize( 'sevenp_blu[et_pb_toggle-toggle_icon_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_toggle-toggle_icon_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_toggle-custom_padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_toggle-custom_padding]',
						'padding',
		...
		/* Contact Form */
			wp.customize( 'sevenp_blu[et_pb_contact_form-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_contact_form-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_contact_form-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_contact_form-title_font_style]',
						'font-styles',
						'.et_pb_contact_form_container .et_pb_contact_main_title',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_contact_form-form_field_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_contact_form-form_field_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_contact_form-form_field_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_contact_form-form_field_font_style]',
						'font-styles',
						'.et_pb_contact_form_container .et_pb_contact p input, .et_pb_contact_form_container .et_pb_contact p textarea',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_contact_form-captcha_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_contact_form-captcha_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_contact_form-captcha_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_contact_form-captcha_font_style]',
						'font-styles',
						'.et_pb_contact_captcha_question',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_contact_form-padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_contact_form-padding]',
						'padding',
		...
		/* Sidebar */
			wp.customize( 'sevenp_blu[et_pb_sidebar-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_sidebar-header_font_style]',
						'font-styles',
			...
			wp.customize( 'sevenp_blu[et_pb_sidebar-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_sidebar-header_font_size]',
						'font-size',
						'.et_pb_widget_area h4',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_sidebar-remove_border]', function( value ) {
				value.bind( function( to ) {
					if ( to ){
		...
		/* Person */
			wp.customize( 'sevenp_blu[et_pb_team_member-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_team_member-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_team_member-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_team_member-header_font_style]',
						'font-styles',
						'.et_pb_team_member h4',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_team_member-subheader_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_team_member-subheader_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_team_member-subheader_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_team_member-subheader_font_style]',
						'font-styles',
						'.et_pb_team_member .et_pb_member_position',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_team_member-social_network_icon_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_team_member-social_network_icon_size]',
						'font-size',
		...
		/* Divider */
			wp.customize( 'sevenp_blu[et_pb_divider-divider_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_divider-divider_style]',
						'border-top-style',
						'.et_pb_space:before',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_divider-divider_weight]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_divider-divider_weight]',
						'border-top-width',
						'.et_pb_space:before',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_divider-height]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_divider-height]',
						'height',
						'.et_pb_space',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_divider-divider_position]', function( value ) {
				value.bind( function( to ) {
		...
		/* Blog */
			wp.customize( 'sevenp_blu[et_pb_blog-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_blog-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_blog-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_blog-header_font_style]',
						'font-styles',
						'.et_pb_posts .et_pb_post h2',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_blog-meta_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_blog-meta_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_blog-meta_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_blog-meta_font_style]',
						'font-styles',
						'.et_pb_posts .et_pb_post .post-meta',
						to
					);
		...
		/* Blog Grid */
			wp.customize( 'sevenp_blu[et_pb_blog_masonry-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_blog_masonry-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_blog_masonry-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_blog_masonry-header_font_style]',
						'font-styles',
						'.et_pb_blog_grid .et_pb_post h2',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_blog_masonry-meta_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_blog_masonry-meta_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_blog_masonry-meta_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_blog_masonry-meta_font_style]',
						'font-styles',
						'.et_pb_blog_grid .et_pb_post .post-meta',
						to
					);
		...
		/* Shop */
			wp.customize( 'sevenp_blu[et_pb_shop-title_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_shop-title_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_shop-title_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_shop-title_font_style]',
						'font-styles',
						'.woocommerce ul.products li.product h3, .woocommerce-page ul.products li.product h3',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_shop-sale_badge_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_shop-sale_badge_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_shop-sale_badge_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_shop-sale_badge_font_style]',
						'font-styles',
						'.woocommerce span.onsale, .woocommerce-page span.onsale',
						to,
						'use_important'
			...
			wp.customize( 'sevenp_blu[et_pb_shop-price_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_shop-price_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_shop-price_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_shop-price_font_style]',
						'font-styles',
						'.woocommerce ul.products li.product .price .amount, .woocommerce-page ul.products li.product .price .amount',
						to,
						'use_important'
			...
			wp.customize( 'sevenp_blu[et_pb_shop-sale_price_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_shop-sale_price_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_shop-sale_price_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_shop-sale_price_font_style]',
						'font-styles',
						'.woocommerce ul.products li.product .price ins .amount, .woocommerce-page ul.products li.product .price ins .amount',
						to,
						'use_important'
		...
		/* Countdown */
			wp.customize( 'sevenp_blu[et_pb_countdown_timer-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_countdown_timer-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_countdown_timer-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_countdown_timer-header_font_style]',
						'font-styles',
						'.et_pb_countdown_timer .title',
						to
					);
		...
		/* Social */
			wp.customize( 'sevenp_blu[et_pb_social_media_follow-button_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_social_media_follow-button_font_style]',
						'font-styles',
			...
			wp.customize( 'sevenp_blu[et_pb_social_media_follow-icon_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_social_media_follow-icon_size]',
						'social-icon-size',
						'',
						to
					);
		...
		/* Fullwidth Slider */
			wp.customize( 'sevenp_blu[et_pb_fullwidth_slider-header_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_fullwidth_slider-header_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_fullwidth_slider-header_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_fullwidth_slider-header_font_style]',
						'font-styles',
						'.et_pb_fullwidth_section .et_pb_slide_description .et_pb_slide_title',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_fullwidth_slider-body_font_size]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_fullwidth_slider-body_font_size]',
						'font-size',
			...
			wp.customize( 'sevenp_blu[et_pb_fullwidth_slider-body_font_style]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_fullwidth_slider-body_font_style]',
						'font-styles',
						'.et_pb_fullwidth_section .et_pb_slide_content',
						to
					);
			...
			wp.customize( 'sevenp_blu[et_pb_fullwidth_slider-padding]', function( value ) {
				value.bind( function( to ) {
					et_print_module_styles_css(
						'sevenp_blu[et_pb_fullwidth_slider-padding]',
						'padding-slider',
	...
	/* Blog Panel */
		wp.customize( 'sevenp_blu[post_meta_font_size]', function( value ) {
			value.bind( function( to ) {
		...
		wp.customize( 'sevenp_blu[post_meta_height]', function( value ) {
			value.bind( function( to ) {
		...
		wp.customize( 'sevenp_blu[post_meta_spacing]', function( value ) {
			value.bind( function( to ) {
		...
		wp.customize( 'sevenp_blu[post_meta_style]', function( value ) {
			value.bind( function( to ) {
		...
		wp.customize( 'sevenp_blu[post_header_font_size]', function( value ) {
			value.bind( function( to ) {
		...
		wp.customize( 'sevenp_blu[post_header_height]', function( value ) {
			value.bind( function( to ) {
		...
		wp.customize( 'sevenp_blu[post_header_spacing]', function( value ) {
			value.bind( function( to ) {
		...
		wp.customize( 'sevenp_blu[post_header_style]', function( value ) {
			value.bind( function( to ) {
				var styles = et_set_font_styles( to, '' ),
	...
	wp.customize( 'sevenp_blu[all_buttons_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_text_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_bg_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_border_width]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_border_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_border_radius]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_font_style]', function( value ) {
		value.bind( function( to ) {
			var styles = et_set_font_styles( to, '' ),
	...
	wp.customize( 'sevenp_blu[primary_nav_font_style]', function( value ) {
		value.bind( function( to ) {
			var styles = et_set_font_styles( to, '' ),
	...
	wp.customize( 'sevenp_blu[secondary_nav_font_style]', function( value ) {
		value.bind( function( to ) {
			var styles = et_set_font_styles( to, '' ),
	...
	wp.customize( 'sevenp_blu[body_header_style]', function( value ) {
		value.bind( function( to ) {
			var styles = et_set_font_styles( to, '' ),
	...
	wp.customize( 'sevenp_blu[all_buttons_selected_icon]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_icon_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_icon_placement]', function( value ) {
		value.bind( function( to ) {
			if ( 'left' === to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_icon_hover]', function( value ) {
		value.bind( function( to ) {
			if ( 'no' === to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_icon]', function( value ) {
		value.bind( function( to ) {
			if ( 'no' === to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_text_color_hover]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_bg_color_hover]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_border_color_hover]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_border_radius_hover]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_spacing]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[all_buttons_spacing_hover]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_show_top_bar]', function( value ) {
		value.bind( function( to ) {
			var $style_content,
	...
	wp.customize( 'sevenp_blu[slide_nav_bg]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_links_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_links_color_active]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_top_color]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_search]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_search_bg]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_width]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_font_style]', function( value ) {
		value.bind( function( to ) {
			var styles = et_set_font_styles( to, '' ),
	...
	wp.customize( 'sevenp_blu[slide_nav_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_top_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[fullscreen_nav_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[fullscreen_nav_top_font_size]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'sevenp_blu[slide_nav_font_spacing]', function( value ) {
		value.bind( function( to ) {
