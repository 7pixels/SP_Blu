...
function et_setup_theme() {
	...
	add_action( 'woocommerce_before_main_content', 'sevenp_blu_output_content_wrapper', 10 );

	remove_action( 'woocommerce_after_main_content', 'woocommerce_output_content_wrapper_end', 10 );
	add_action( 'woocommerce_after_main_content', 'sevenp_blu_output_content_wrapper_end', 10 );
...
if ( ! function_exists( 'sevenp_blu_fonts_url' ) ) :
function sevenp_blu_fonts_url() {
	$fonts_url = '';
...
function sevenp_blu_load_fonts() {
	$fonts_url = sevenp_blu_fonts_url();
	if ( ! empty( $fonts_url ) )
		wp_enqueue_style( 'blu-fonts', esc_url_raw( $fonts_url ), array(), null );
}
add_action( 'wp_enqueue_scripts', 'sevenp_blu_load_fonts' );
...
function sevenp_blu_load_scripts_styles(){
	global $wp_styles;
	...
	wp_enqueue_script( 'blu-custom-script', $template_dir . '/js/custom.js', $dependencies_array , $theme_version, true );
	 ...
	 */
	wp_enqueue_style( 'blu-style', get_stylesheet_uri(), array(), $theme_version );
}
add_action( 'wp_enqueue_scripts', 'sevenp_blu_load_scripts_styles' );
...
function sevenp_blu_post_settings_save_details( $post_id, $post ){
	global $pagenow;
...
add_action( 'save_post', 'sevenp_blu_post_settings_save_details', 10, 2 );
...
function sevenp_blu_customize_register( $wp_customize ) {
	...
	if ( isset( $_GET[ $option_set_name ] ) && in_array( $_GET[ $option_set_name ], $option_set_allowed_values ) ) {
		...
		set_transient( 'sevenp_blu_customizer_option_set', $customizer_option_set, DAY_IN_SECONDS );
	}

	if ( '' === $customizer_option_set && ( $et_customizer_option_set_value = get_transient( 'sevenp_blu_customizer_option_set' ) ) ) {
	...
	if ( isset( $customizer_option_set ) && 'module' === $customizer_option_set ) {
		...
		sevenp_blu_customizer_module_settings( $wp_customize );
	} else {
...
add_action( 'customize_register', 'sevenp_blu_customize_register' );

if ( ! function_exists( 'sevenp_blu_customizer_theme_settings' ) ) :
function sevenp_blu_customizer_theme_settings( $wp_customize ) {
	$site_domain = get_locale();
	...
	$wp_customize->add_setting( 'sevenp_blu[post_meta_font_size]', array(
		'default'       => '14',
		'type'          => 'option',
	...
	$wp_customize->add_setting( 'sevenp_blu[post_meta_height]', array(
		'default'       => '1',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[post_meta_spacing]', array(
		'default'       => '0',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[post_meta_style]', array(
		'default'       => '',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[post_header_font_size]', array(
		'default'       => '30',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[post_header_height]', array(
		'default'       => '1',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[post_header_spacing]', array(
		'default'       => '0',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[post_header_style]', array(
		'default'       => '',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[boxed_layout]', array(
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[content_width]', array(
		'default'       => '1080',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[gutter_width]', array(
		'default'       => '3',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[use_sidebar_width]', array(
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
		'sanitize_callback' => 'wp_validate_boolean',
	...
	$wp_customize->add_setting( 'sevenp_blu[sidebar_width]', array(
		'default'       => '21',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[section_padding]', array(
		'default'       => '4',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[phone_section_height]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[tablet_section_height]', array(
		'default'       => '50',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[row_padding]', array(
		'default'       => '2',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[phone_row_height]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[tablet_row_height]', array(
		'default'       => '30',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[cover_background]', array(
		'default'       => 'on',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[body_font_size]', array(
		'default'       => '14',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[body_font_height]', array(
		'default'       => '1.7',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[phone_body_font_size]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[tablet_body_font_size]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[body_header_size]', array(
		'default'       => '30',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[body_header_spacing]', array(
		'default'       => '0',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[body_header_height]', array(
		'default'       => '1',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[body_header_style]', array(
		'default'       => '',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[phone_header_font_size]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[tablet_header_font_size]', array(
	...
	if ( ! isset( $et_one_font_languages[$site_domain] ) ) {
		$wp_customize->add_setting( 'sevenp_blu[heading_font]', array(
			'default'		=> 'none',
			'type'			=> 'option',
			'capability'	=> 'edit_theme_options',
			'transport'		=> 'postMessage',
		...
		$wp_customize->add_setting( 'sevenp_blu[body_font]', array(
			'default'		=> 'none',
			'type'			=> 'option',
			'capability'	=> 'edit_theme_options',
			'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[link_color]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[font_color]', array(
		'default'		=> '#666666',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[header_color]', array(
		'default'		=> '#666666',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[accent_color]', array(
		'default'		=> '#2ea3f2',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[color_schemes]', array(
		'default'		=> 'none',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_control( 'sevenp_blu[color_schemes]', array(
		...
		'type'		=> 'select',
		'choices'	=> sevenp_blu_color_scheme_choices(),
	) );

	$wp_customize->add_setting( 'sevenp_blu[header_style]', array(
		'default'       => 'left',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[vertical_nav]', array(
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
		'sanitize_callback' => 'wp_validate_boolean',
	...
	$wp_customize->add_setting( 'sevenp_blu[vertical_nav_orientation]', array(
		'default'       => 'left',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[show_search_icon]', array(
		'default'       => 'on',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_show_top_bar]', array(
		'default'       => 'on',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_width]', array(
		'default'       => '320',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_font_size]', array(
		'default'       => '14',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_top_font_size]', array(
		'default'       => '14',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[fullscreen_nav_font_size]', array(
		'default'       => '30',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[fullscreen_nav_top_font_size]', array(
		'default'       => '18',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_font_spacing]', array(
		'default'       => '0',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	if ( ! isset( $et_one_font_languages[$site_domain] ) ) {
		$wp_customize->add_setting( 'sevenp_blu[slide_nav_font]', array(
			'default'		=> 'none',
			'type'			=> 'option',
			'capability'	=> 'edit_theme_options',
			'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_font_style]', array(
		'default'       => '',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_bg]', array(
		'default'		=> et_get_option( 'accent_color', '#2ea3f2' ),
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_links_color]', array(
		'default'		=> '#ffffff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_links_color_active]', array(
		'default'		=> '#ffffff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_top_color]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_search]', array(
		'default'		=> 'rgba(255,255,255,0.6)',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[slide_nav_search_bg]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[nav_fullwidth]', array(
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
		'sanitize_callback' => 'wp_validate_boolean',
	...
	$wp_customize->add_setting( 'sevenp_blu[hide_primary_logo]', array(
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
		'sanitize_callback' => 'wp_validate_boolean',
	...
	$wp_customize->add_setting( 'sevenp_blu[menu_height]', array(
		'default'       => '66',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[logo_height]', array(
		'default'       => '54',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[menu_margin_top]', array(
		'default'       => '0',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[primary_nav_font_size]', array(
		'default'       => '14',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[primary_nav_font_spacing]', array(
		'default'       => '0',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	if ( ! isset( $et_one_font_languages[$site_domain] ) ) {
		$wp_customize->add_setting( 'sevenp_blu[primary_nav_font]', array(
			'default'		=> 'none',
			'type'			=> 'option',
			'capability'	=> 'edit_theme_options',
			'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[primary_nav_font_style]', array(
		'default'       => '',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_font_size]', array(
		'default'       => '12',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_fullwidth]', array(
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
		'sanitize_callback' => 'wp_validate_boolean',
	...
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_font_spacing]', array(
		'default'       => '0',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	if ( ! isset( $et_one_font_languages[$site_domain] ) ) {
		$wp_customize->add_setting( 'sevenp_blu[secondary_nav_font]', array(
			'default'		=> 'none',
			'type'			=> 'option',
			'capability'	=> 'edit_theme_options',
			'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_font_style]', array(
		'default'       => '',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[menu_link]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[hide_mobile_logo]', array(
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
		'sanitize_callback' => 'wp_validate_boolean',
	...
	$wp_customize->add_setting( 'sevenp_blu[mobile_menu_link]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[menu_link_active]', array(
		'default'		=> et_get_option( 'accent_color', '#2ea3f2' ),
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[primary_nav_bg]', array(
		'default'		=> '#ffffff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[primary_nav_dropdown_bg]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[primary_nav_dropdown_line_color]', array(
		'default'		=> et_get_option( 'accent_color', '#2ea3f2' ),
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[primary_nav_dropdown_link_color]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[primary_nav_dropdown_animation]', array(
		'default'       => 'fade',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[mobile_primary_nav_bg]', array(
		'default'		=> et_get_option( 'primary_nav_bg', '#ffffff' ),
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_bg]', array(
		'default'		=> et_get_option( 'accent_color', '#2ea3f2' ),
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_text_color_new]', array(
		'default'		=> '#ffffff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_dropdown_bg]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_dropdown_link_color]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_dropdown_animation]', array(
		'default'       => 'fade',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[primary_nav_text_color]', array(
		'default'       => 'dark',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	// Setting with no control kept for backwards compatbility
	$wp_customize->add_setting( 'sevenp_blu[secondary_nav_text_color]', array(
		'default'       => 'light',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	if ( 'on' === et_get_option( 'blu_fixed_nav', 'on' ) ) {
		...
		$wp_customize->add_setting( 'sevenp_blu[minimized_menu_height]', array(
			'default'       => '40',
			'type'          => 'option',
			'capability'    => 'edit_theme_options',
			'transport'     => 'postMessage',
		...
		$wp_customize->add_setting( 'sevenp_blu[fixed_primary_nav_font_size]', array(
		...
		$wp_customize->add_setting( 'sevenp_blu[fixed_primary_nav_bg]', array(
			'default'		=> et_get_option( 'primary_nav_bg', '#ffffff' ),
			'type'			=> 'option',
			'capability'	=> 'edit_theme_options',
			'transport'		=> 'postMessage',
		...
		$wp_customize->add_setting( 'sevenp_blu[fixed_secondary_nav_bg]', array(
		...
		$wp_customize->add_setting( 'sevenp_blu[fixed_menu_link]', array(
			'default'       => et_get_option( 'menu_link', 'rgba(0,0,0,0.6)' ),
			'type'			=> 'option',
			'capability'	=> 'edit_theme_options',
			'transport'		=> 'postMessage',
		...
		$wp_customize->add_setting( 'sevenp_blu[fixed_secondary_menu_link]', array(
			'default'       => et_get_option( 'secondary_nav_text_color_new', '#ffffff' ),
			'type'			=> 'option',
			'capability'	=> 'edit_theme_options',
			'transport'		=> 'postMessage',
		...
		$wp_customize->add_setting( 'sevenp_blu[fixed_menu_link_active]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[phone_number]', array(
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[header_email]', array(
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[show_footer_social_icons]', array(
		'default'       => 'on',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_columns]', array(
		'default'       => '4',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_control( 'sevenp_blu[footer_columns]', array(
		...
		'type'		=> 'select',
		'choices'	=> sevenp_blu_footer_column_choices(),
	) );

	$wp_customize->add_setting( 'sevenp_blu[footer_bg]', array(
		'default'		=> '#222222',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[widget_header_font_size]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[widget_header_font_style]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[widget_body_font_size]', array(
		'default'       => et_get_option( 'body_font_size', '14' ),
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[widget_body_line_height]', array(
		'default'       => '1.7',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[widget_body_font_style]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_widget_text_color]', array(
		'default'		=> '#fff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_widget_link_color]', array(
		'default'		=> '#fff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_widget_header_color]', array(
		'default'		=> et_get_option( 'accent_color', '#2ea3f2' ),
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_widget_bullet_color]', array(
		'default'		=> et_get_option( 'accent_color', '#2ea3f2' ),
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	/* Footer Menu */
	$wp_customize->add_setting( 'sevenp_blu[footer_menu_background_color]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_menu_text_color]', array(
		'default'		=> '#bbbbbb',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_menu_active_link_color]', array(
		'default'		=> et_get_option( 'accent_color', '#2ea3f2' ),
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_menu_letter_spacing]', array(
		'default'       => '0',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_menu_font_style]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[footer_menu_font_size]', array(
		'default'       => '14',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	/* Bottom Bar */
	$wp_customize->add_setting( 'sevenp_blu[bottom_bar_background_color]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[bottom_bar_text_color]', array(
		'default'		=> '#666666',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[bottom_bar_font_style]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[bottom_bar_font_size]', array(
		'default'       => '14',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[bottom_bar_social_icon_size]', array(
		'default'       => '24',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[bottom_bar_social_icon_color]', array(
		'default'		=> '#666666',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[disable_custom_footer_credits]', array(
		'type'              => 'option',
		'capability'        => 'edit_theme_options',
		'transport'         => 'postMessage',
		'sanitize_callback' => 'wp_validate_boolean',
	...
	$wp_customize->add_setting( 'sevenp_blu[custom_footer_credits]', array(
		'default'           => '',
		'type'              => 'option',
		'capability'        => 'edit_theme_options',
		'transport'         => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_font_size]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_text_color]', array(
		'default'		=> '#ffffff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_bg_color]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_border_width]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_border_color]', array(
		'default'		=> '#ffffff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_border_radius]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_spacing]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_font_style]', array(
		'default'       => '',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	if ( ! isset( $et_one_font_languages[$site_domain] ) ) {
		$wp_customize->add_setting( 'sevenp_blu[all_buttons_font]', array(
			'default'		=> 'none',
			'type'			=> 'option',
			'capability'	=> 'edit_theme_options',
			'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_icon]', array(
		'default'       => 'yes',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_selected_icon]', array(
		'default'       => '5',
		'type'          => 'option',
		'capability'    => 'edit_theme_options',
		'transport'     => 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_icon_color]', array(
		'default'		=> '#ffffff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_icon_placement]', array(
		'default'       => 'right',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_icon_hover]', array(
		'default'       => 'yes',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_text_color_hover]', array(
		'default'		=> '#ffffff',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_bg_color_hover]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_border_color_hover]', array(
		'default'		=> 'rgba(0,0,0,0)',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_border_radius_hover]', array(
	...
	$wp_customize->add_setting( 'sevenp_blu[all_buttons_spacing_hover]', array(
...
if ( ! function_exists( 'sevenp_blu_customizer_module_settings' ) ) :
function sevenp_blu_customizer_module_settings( $wp_customize ) {
		/* Section: Image */
		...
		$wp_customize->add_section( 'et_pagebuilder_gallery', array(
			...
			// Zoom Icon Color
			$wp_customize->add_setting( 'sevenp_blu[et_pb_gallery-zoom_icon_color]', array(
			...
			// Hover Overlay Color
			$wp_customize->add_setting( 'sevenp_blu[et_pb_gallery-hover_overlay_color]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_gallery-title_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_gallery-title_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_gallery-caption_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_gallery-caption_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_blurb', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_blurb-header_font_size]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_tabs', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_tabs-title_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_tabs-title_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_tabs-padding]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_slider', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_slider-padding]', array(
			...
			// Header Font size: Range 10px - 72px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_slider-header_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_slider-header_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_slider-body_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_slider-body_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_testimonial', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_testimonial-author_name_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_testimonial-author_details_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_testimonial-portrait_border_radius]', array(
			...
			// Portrait Width
			$wp_customize->add_setting( 'sevenp_blu[et_pb_testimonial-portrait_width]', array(
			...
			// Portrait Height
			$wp_customize->add_setting( 'sevenp_blu[et_pb_testimonial-portrait_height]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_pricing_table', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_pricing_tables-header_font_size]', array(
			...
			// Header Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_pricing_tables-header_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_pricing_tables-subheader_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_pricing_tables-subheader_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_pricing_tables-price_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_pricing_tables-price_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_call_to_action', array(
			...
			// Header font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_cta-header_font_size]', array(
			...
			// Header Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_cta-header_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_cta-custom_padding]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_audio', array(
			...
			// Header Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_audio-title_font_size]', array(
			...
			// Header Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_audio-title_font_style]', array(
			...
			// Subhead Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_audio-caption_font_size]', array(
			...
			// Subhead Font Style:  B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_audio-caption_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_subscribe', array(
			...
			// Header font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_signup-header_font_size]', array(
			...
			// Header Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_signup-header_font_style]', array(
			...
			// Padding: Range 0px - 200px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_signup-padding]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_login', array(
			...
			// Header font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_login-header_font_size]', array(
			...
			// Header Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_login-header_font_style]', array(
			...
			// Padding: Range 0px - 200px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_login-custom_padding]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_portfolio', array(
			...
			// Zoom Icon Color
			$wp_customize->add_setting( 'sevenp_blu[et_pb_portfolio-zoom_icon_color]', array(
			...
			// Hover Overlay Color
			$wp_customize->add_setting( 'sevenp_blu[et_pb_portfolio-hover_overlay_color]', array(
			...
			// Title Font Size: Range 10px - 72px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_portfolio-title_font_size]', array(
			...
			// Title Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_portfolio-title_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_portfolio-caption_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_portfolio-caption_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_filterable_portfolio', array(
			...
			// Zoom Icon Color
			$wp_customize->add_setting( 'sevenp_blu[et_pb_filterable_portfolio-zoom_icon_color]', array(
			...
			// Hover Overlay Color
			$wp_customize->add_setting( 'sevenp_blu[et_pb_filterable_portfolio-hover_overlay_color]', array(
			...
			// Title Font Size: Range 10px - 72px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_filterable_portfolio-title_font_size]', array(
			...
			// Title Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_filterable_portfolio-title_font_style]', array(
			...
			// Category font size Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_filterable_portfolio-caption_font_size]', array(
			...
			// Category Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_filterable_portfolio-caption_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_filterable_portfolio-filter_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_filterable_portfolio-filter_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_bar_counter', array(
			...
			// Label Font Size
			$wp_customize->add_setting( 'sevenp_blu[et_pb_counters-title_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_counters-title_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_counters-percent_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_counters-percent_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_counters-padding]', array(
			...
			// Bar Border Radius
			$wp_customize->add_setting( 'sevenp_blu[et_pb_counters-border_radius]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_circle_counter', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_circle_counter-number_font_style]', array(
			...
			// Title Font Size: Range 10px - 72px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_circle_counter-title_font_size]', array(
			...
			// Title Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_circle_counter-title_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_number_counter', array(
			...
			// Number Font Size
			$wp_customize->add_setting( 'sevenp_blu[et_pb_number_counter-number_font_size]', array(
			...
			// Number Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_number_counter-number_font_style]', array(
			...
			// Title Font Size: Range 10px - 72px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_number_counter-title_font_size]', array(
			...
			// Title Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_number_counter-title_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_accordion', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_accordion-toggle_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_accordion-inactive_toggle_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_accordion-toggle_icon_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_accordion-custom_padding]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_toggle', array(
			...
			// Title Font Size
			$wp_customize->add_setting( 'sevenp_blu[et_pb_toggle-title_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_toggle-title_font_style]', array(
				'default'       => ET_Global_Settings::get_value( 'et_pb_toggle-title_font_size', 'default' ),
				'type'          => 'option',
				'capability'    => 'edit_theme_options',
				'transport'     => 'postMessage',
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_toggle-inactive_title_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_toggle-toggle_icon_size]', array(
			...
			// Padding: Range 0 - 50px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_toggle-custom_padding]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_contact_form', array(
			...
			// Header Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_contact_form-title_font_size]', array(
			...
			// Header Font Style:  B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_contact_form-title_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_contact_form-form_field_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_contact_form-form_field_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_contact_form-padding]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_contact_form-captcha_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_contact_form-captcha_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_sidebar', array(
			...
			// Header Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_sidebar-header_font_size]', array(
			...
			// Header font style
			$wp_customize->add_setting( 'sevenp_blu[et_pb_sidebar-header_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_sidebar-remove_border]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_divider', array(
			...
			// Show/hide Divider
			$wp_customize->add_setting( 'sevenp_blu[et_pb_divider-show_divider]', array(
				'type'			=> 'option',
				'capability'	=> 'edit_theme_options',
				'transport'		=> 'postMessage',
				'sanitize_callback' => 'wp_validate_boolean',
			...
			// Divider Style
			$wp_customize->add_setting( 'sevenp_blu[et_pb_divider-divider_style]', array(
			...
			$wp_customize->add_control( 'sevenp_blu[et_pb_divider-divider_style]', array(
				...
				'type'		=> 'select',
				'choices'	=> sevenp_blu_divider_style_choices(),
			) );

			// Divider Weight
			$wp_customize->add_setting( 'sevenp_blu[et_pb_divider-divider_weight]', array(
			...
			// Divider Height
			$wp_customize->add_setting( 'sevenp_blu[et_pb_divider-height]', array(
			...
			// Divider Position
			$wp_customize->add_setting( 'sevenp_blu[et_pb_divider-divider_position]', array(
			...
			$wp_customize->add_control( 'sevenp_blu[et_pb_divider-divider_position]', array(
				...
				'type'		=> 'select',
				'choices'	=> sevenp_blu_divider_position_choices(),
			) );
		...
		$wp_customize->add_section( 'et_pagebuilder_person', array(
			...
			// Header Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_team_member-header_font_size]', array(
			...
			// Header font style
			$wp_customize->add_setting( 'sevenp_blu[et_pb_team_member-header_font_style]', array(
			...
			// Subhead Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_team_member-subheader_font_size]', array(
			...
			// Subhead Font Style:  B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_team_member-subheader_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_team_member-social_network_icon_size]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_blog', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_blog-header_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_blog-header_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_blog-meta_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_blog-meta_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_masonry_blog', array(
			...
			// Post Title Font Size
			$wp_customize->add_setting( 'sevenp_blu[et_pb_blog_masonry-header_font_size]', array(
			...
			// Post Title Font Style
			$wp_customize->add_setting( 'sevenp_blu[et_pb_blog_masonry-header_font_style]', array(
			...
			// Meta Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_blog_masonry-meta_font_size]', array(
			...
			// Meta Field Font Style:  B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_blog_masonry-meta_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_shop', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_shop-title_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_shop-title_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_shop-sale_badge_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_shop-sale_badge_font_style]', array(
			...
			// Price Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_shop-price_font_size]', array(
			...
			// Price Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_shop-price_font_style]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_shop-sale_price_font_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_shop-sale_price_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_countdown', array(
			...
			// Header Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_countdown_timer-header_font_size]', array(
			...
			// Header Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_countdown_timer-header_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_social_follow', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_social_media_follow-icon_size]', array(
			...
			$wp_customize->add_setting( 'sevenp_blu[et_pb_social_media_follow-button_font_style]', array(
		...
		$wp_customize->add_section( 'et_pagebuilder_fullwidth_slider', array(
			...
			// Slider Padding: Top/Bottom Only
			$wp_customize->add_setting( 'sevenp_blu[et_pb_fullwidth_slider-padding]', array(
			...
			// Header Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_fullwidth_slider-header_font_size]', array(
			...
			// Header Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_fullwidth_slider-header_font_style]', array(
			...
			// Content Font size: Range 10px - 32px
			$wp_customize->add_setting( 'sevenp_blu[et_pb_fullwidth_slider-body_font_size]', array(
			...
			// Content Font Style: B / I / TT / U
			$wp_customize->add_setting( 'sevenp_blu[et_pb_fullwidth_slider-body_font_style]', array(
...
function sevenp_blu_customize_preview_js() {
	$theme_version = et_get_theme_version();
	wp_enqueue_script( 'blu-customizer', get_template_directory_uri() . '/js/theme-customizer.js', array( 'customize-preview' ), $theme_version, true );
	wp_localize_script( 'blu-customizer', 'et_main_customizer_data', array(
		'original_footer_credits' => et_get_original_footer_credits(),
	) );
}
add_action( 'customize_preview_init', 'sevenp_blu_customize_preview_js' );

function sevenp_blu_customize_preview_css() {
	$theme_version = et_get_theme_version();

	wp_enqueue_style( 'blu-customizer-controls-styles', get_template_directory_uri() . '/css/theme-customizer-controls-styles.css', array(), $theme_version );
	wp_enqueue_script( 'blu-customizer-controls-js', get_template_directory_uri() . '/js/theme-customizer-controls.js', array( 'jquery' ), $theme_version, true );
	wp_localize_script( 'blu-customizer-controls-js', 'sevenp_blu_customizer_data', array(
		'is_old_wp' => et_pb_is_wp_old_version() ? 'old' : 'new',
	) );
}
add_action( 'customize_controls_enqueue_scripts', 'sevenp_blu_customize_preview_css' );
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class ET_Divi_Range_Option extends WP_Customize_Control {
		...
		<label>
			...
			<span class="sevenp_blu_reset_slider"></span>
		</label>
		<?php
		}
	}
...
function sevenp_blu_add_customizer_css(){ ?>
	<?php
...
add_action( 'wp_head', 'sevenp_blu_add_customizer_css' );
...
function sevenp_blu_post_admin_scripts_styles( $hook ) {
	global $typenow;
...
add_action( 'admin_enqueue_scripts', 'sevenp_blu_post_admin_scripts_styles' );
...
function et_layout_body_class( $classes ) {
	...
	$et_secondary_nav_items = sevenp_blu_get_top_nav_items();
...
if ( ! function_exists( 'sevenp_blu_get_top_nav_items' ) ) {
	function sevenp_blu_get_top_nav_items() {
		$items = new stdClass;
...
add_filter( 'body_class', 'sevenp_blu_sidebar_class' );

/**
 * Custom body classes for handling customizer preview screen
 * @return array
 */
function sevenp_blu_customize_preview_class( $classes ) {
	if ( is_customize_preview() ) {
		// Search icon state
...
add_filter( 'body_class', 'sevenp_blu_customize_preview_class' );
...
if ( is_admin() && isset( $_GET['activated'] ) && $pagenow == 'themes.php' ) {
	...
	add_action( 'init', 'sevenp_blu_woocommerce_image_dimensions', 1 );
}
...
function sevenp_blu_woocommerce_image_dimensions() {
	$catalog = array(
		'width' 	=> '400',
		'height'	=> '400',
		'crop'		=> 1,
...
function sevenp_blu_output_content_wrapper() {
	echo '
		<div id="main-content">
			<div class="container">
...
function sevenp_blu_output_content_wrapper_end() {
	echo '</div> <!-- #left-area -->';
...
function et_add_blu_menu() {
	...
	if ( et_pb_is_allowed( 'theme_options' ) ) {
		...
		if ( isset( $_GET['page'] ) && 'sevenp_blu_options' === $_GET['page'] && isset( $_POST['action'] ) ) {
			if (
...
function et_pb_hide_options_menu() {
	...
	wp_enqueue_script( 'blu-custom-admin-menu', get_template_directory_uri() . '/js/menu_fix.js', array( 'jquery' ), $theme_version, true );
}
...
add_filter( 'locale', 'sevenp_blu_maybe_change_frontend_locale' );
...
add_filter( 'et_gallery_layout_enable', 'sevenp_blu_gallery_layout_enable' );
 ...
 */
function sevenp_blu_register_customizer_portability() {
	global $options;
...
add_action( 'admin_init', 'sevenp_blu_register_customizer_portability' );
 ...
 * @return bool Always return true.
 */
function sevenp_blu_customizer_link() {
	if ( is_customize_preview() ) {
		echo et_core_portability_link( 'sevenp_blu_mods', array( 'class' => 'customize-controls-close' ) );
	}
}
add_action( 'customize_controls_print_footer_scripts', 'sevenp_blu_customizer_link' );

/**
 * Added body class to make it possible to identify the Divi theme on frontend
 * @return array
 */
function sevenp_blu_theme_body_class( $classes ) {
	$classes[] = 'sevenp_blu_theme';

	return $classes;
}
add_filter( 'body_class', 'sevenp_blu_theme_body_class' );

if ( ! function_exists( 'et_get_original_footer_credits' ) ) :
function et_get_original_footer_credits() {
	return sprintf( __( 'Copyright &copy; %1$s | Powered by %2$s', 'Blu' ), '<a href="/" title="Nobelfield">Noblefield Oil Services Ltd</a>', '<a href="http://7pixelsgh.com">7pixels</a>' );
}
endif;
