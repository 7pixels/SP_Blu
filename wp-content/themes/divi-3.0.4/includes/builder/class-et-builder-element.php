...
class ET_Builder_Element {
	...
	static function set_style( $function_name, $style ) {
		...
		// Prepend .sevenp_blu_builder class before all CSS rules in the Divi Builder plugin
		if ( et_is_builder_plugin_active() ) {
			$order_class_name = "sevenp_blu_builder #et_builder_outer_content .$order_class_name";
		}
