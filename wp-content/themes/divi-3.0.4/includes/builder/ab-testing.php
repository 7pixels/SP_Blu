...
function et_pb_ab_get_stats_data( $post_id, $duration = 'week', $time = false, $force_update = false ) {
	...
	$table_name = $wpdb->prefix . 'sevenp_blu_ab_testing_stats';
...
function et_pb_create_ab_tables() {
	...
	$stats_table_name = $wpdb->prefix . 'sevenp_blu_ab_testing_stats';
	$client_subject_table_name = $wpdb->prefix . 'sevenp_blu_ab_testing_clients';
...
function et_pb_ab_remove_stats( $test_id ) {
	...
	foreach ( array( 'stats', 'clients' ) as $table_suffix ) {
		$table_name = $wpdb->prefix . 'sevenp_blu_ab_testing_' . $table_suffix;
