...
if ( ! function_exists( 'sevenp_blu_get_projects' ) ) :
function sevenp_blu_get_projects( $args = array() ) {
	$default_args = array(
		'post_type' => 'project',
	);
...
function et_pb_add_builder_page_js_css(){
	...
	wp_localize_script( 'et_pb_admin_js', 'et_pb_options', apply_filters( 'et_pb_options_builder', array_merge( array(
		...
		'is_blu_library'                          => 'et_pb_layout' === $typenow ? 1 : 0,
 ...
 */
if ( ! function_exists( 'sevenp_blu_post_format_content' ) ) :
function sevenp_blu_post_format_content() {
	$post_format = et_pb_post_format();

	$text_color_class = sevenp_blu_get_post_text_color();

	$inline_style = sevenp_blu_get_post_bg_inline_style();
...
if ( ! function_exists( 'sevenp_blu_get_post_text_color' ) ) {
	function sevenp_blu_get_post_text_color() {
		$text_color_class = '';
...
if ( ! function_exists( 'sevenp_blu_get_post_bg_inline_style' ) ) {
	function sevenp_blu_get_post_bg_inline_style() {
		$inline_style = '';
...
function et_pb_get_options_page_link() {
	if ( et_is_builder_plugin_active() ) {
		return admin_url( 'admin.php?page=sevenp_blu_options#tab_et_dashboard_tab_content_api_main' );
	}

	return apply_filters( 'et_pb_theme_options_link', admin_url( 'admin.php?page=sevenp_blu_options' ) );
}
