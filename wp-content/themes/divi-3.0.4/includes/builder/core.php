...
function et_builder_should_load_framework() {
	...
	$is_role_editor_page = 'admin.php' === $pagenow && isset( $_GET['page'] ) && apply_filters( 'sevenp_blu_role_editor_page', 'sevenp_blu_role_editor' ) === $_GET['page'];
...
function et_pb_ab_get_saved_ab_module_id( $test_id, $client_id ) {
	...
	$table_name = $wpdb->prefix . 'sevenp_blu_ab_testing_clients';
