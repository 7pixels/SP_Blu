(function($){
	$( document ).ready( function() {
		...
		if ( typeof tab_link !== 'undefined' ) {
			var $menu_items = $( '#toplevel_page_sevenp_blu_library' ).find( '.wp-submenu li' );
			...
			$( '#toplevel_page_sevenp_blu_library' ).removeClass( 'wp-not-current-submenu' ).addClass( 'wp-has-current-submenu' );
			$( 'a.toplevel_page_sevenp_blu_library' ).removeClass( 'wp-not-current-submenu' ).addClass( 'wp-has-current-submenu wp-menu-open' );
		}
